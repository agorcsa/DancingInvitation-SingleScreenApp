...
(function(_, PROTO) {
  ...
  AvastWRC.Query.Vote = function(options){
      ...
      // Are we getting or putting the vote
      if(this.options.method == "put") {
        this.request = new AvastWRC.gpb.All.PutVoteRequest;
        this.response = null;
        this.options.format = 'string';
      } else { // get uses POST
        this.request = new AvastWRC.gpb.All.GetVoteRequest;
        this.response = new AvastWRC.gpb.All.PutVoteRequest;
      }
  ...
  AvastWRC.Query.Vote.prototype = _.extend({},AvastWRC.Query.__MASTER__,{
    message : function(){
      ...
      if(this.options.method.toLowerCase() == "put") {

  ...
  AvastWRC.bal = {
    ...
    init: function(browserType, _back, locStorage, editionConfig, forceEdition) {
      ...
      if (avastConfig) {
		  ...
		  //guid: if Avast is not there this is the GUID, as soon as Avast is there this GUID will be overwritten
		  var guid = AvastWRC.bal.utils.getRandomUID();
		  if (AvastWRC.CONFIG.GUID == null) AvastWRC.CONFIG.GUID = guid;
          var guids = new Object();
          guids.guid = AvastWRC.CONFIG.GUID;
          guids.auid = AvastWRC.CONFIG.AUID;
          guids.hwid = AvastWRC.CONFIG.HWID;
          guids.uuid = AvastWRC.CONFIG.UUID;
              ...
              elements: [
                {
                  ...
                  color:  RATING_COLOR[RATING_GOOD], //'#32b576',
                  color_left: '#47cb83'
                },
                {
                  ...
                  color: '#d84753',
                  color_left: RATING_COLOR[RATING_BAD]
                }
              ],
              negative: {
                close : AvastWRC.bs.getLocalImageURL('icn_close_small.png'),
